    ...
    <Layout>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="card prose prose-sm max-w-none">
          <h3 className="text-lg font-bold text-dark">1. Quem pode participar</h3>
          ...
          <h3 className="text-lg font-bold text-dark mt-6">2. Valor da inscrição</h3>
          <p className="text-gray-700">
          ...
          <h3 className="text-lg font-bold text-dark mt-6">3. Como pontuar</h3>
          ...
          <h3 className="text-lg font-bold text-dark mt-6">4. Bônus</h3>
          <p className="text-gray-700">
          ...
          <h3 className="text-lg font-bold text-dark mt-6">5. Regra dos pênaltis</h3>
          <p className="text-gray-700">
          ...
          <h3 className="text-lg font-bold text-dark mt-6">6. Prazo do palpite</h3>
          <p className="text-gray-700">
          ...
          <h3 className="text-lg font-bold text-dark mt-6">7. Sigilo</h3>
          <p className="text-gray-700">
          ...
          <h3 className="text-lg font-bold text-dark mt-6">8. Critérios de desempate</h3>
          ...
          <h3 className="text-lg font-bold text-dark mt-6">9. Premiação</h3>
          <p className="text-gray-700">
